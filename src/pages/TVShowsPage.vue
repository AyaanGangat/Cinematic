<template>
  <q-page class="q-pa-md">
    <div class="text-h4 q-mb-md">TV Shows</div>

    <div class="row q-col-gutter-md">
      <div class="col-6 col-sm-4 col-md-3 col-lg-2" v-for="show in shows" :key="show.id">
        <media-card
          :title="show.name"
  ...
  setup() {
    ...
    const fetchShows = async () => {
      ...
      try {
        ...
        shows.value = [...shows.value, ...response.results]
      } catch (error) {
